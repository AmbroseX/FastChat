...
# pip install torch==2.1.2 torchvision==0.16.2 torchaudio==2.1.2 xformers==0.0.23.post1 --index-url https://download.pytorch.org/whl/cu118 --cache-dir=~/.cache/pip
pip install torch==2.1.0 torchvision==0.16.0 torchaudio==2.1.0 xformers==0.0.22.post4 --index-url https://download.pytorch.org/whl/cu118
