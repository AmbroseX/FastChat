...
export model_path='/platform_tech/xiongrongkang/checkpoint/qinshu/qwen14b_all_in_one_11000/test_model_1600'
# "python3 -m fastchat.serve.register_worker --controller http://192.168.72.34:22001 --worker-name http://192.168.190.79:27001"
