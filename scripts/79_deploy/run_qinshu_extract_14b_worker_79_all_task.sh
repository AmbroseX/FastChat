...
export NODE_RANK=6,7
export NUM_GPUS=2
export RAY_memory_monitor_refresh_ms=0
echo "load Model: worker_79_qinshu_worker_llm-qwen-alltask-eval" > /platform_tech/logs/worker_79_qinshu_worker_llm-qwen-alltask-eval.log
nohup env CUDA_VISIBLE_DEVICES=${NODE_RANK} python3 -m fastchat.serve.vllm_worker \
    ...
    >> /platform_tech/logs/worker_79_qinshu_worker_llm-qwen-alltask-eval.log 2>&1 &