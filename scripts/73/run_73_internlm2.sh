# internlm2
# internlm2-chat-7b
echo "load Model: internlm2-chat-7b" > ./logs/worker_73_internlm2-chat-7b.log
nohup env CUDA_VISIBLE_DEVICES=2 python3 ./fastchat/serve/model_worker.py \
    ...
    >> ./logs/worker_73_internlm2-chat-7b.log 2>&1 &

# internlm2-chat-20b
echo "load Model: internlm2-chat-20b" > ./logs/worker_73_internlm2-chat-20b.log
nohup env CUDA_VISIBLE_DEVICES=3,2 python3 ./fastchat/serve/model_worker.py \
    --controller-address http://192.168.72.34:22001 \
    --host 192.168.190.73 --port 22012 \
    --worker-address http://192.168.190.73:22012 \
    --model-path /platform_tech/models/internlm2-chat-20b \
    --model-names internlm2-chat-20b \
    --limit-worker-concurrency 10 \
    >> ./logs/worker_73_internlm2-chat-20b.log 2>&1 &
