...
echo "load Model: Qwen1.5-1.8B-Chat"  > ./logs/worker_34_Qwen1.5-1.8B-Chat.log
nohup env CUDA_VISIBLE_DEVICES=7 python3 -m fastchat.serve.vllm_worker \
    ...
    > ./logs/worker_34_Qwen1.5-1.8B-Chat.log 2>&1 &
...
# vllm方式启动
echo "load Model: Qwen1.5-7B-Chat"  > ./logs/worker_34_Qwen1.5-7B-Chat.log
nohup env CUDA_VISIBLE_DEVICES=2 python3 -m fastchat.serve.vllm_worker \
    ...
    >> ./logs//worker_34_Qwen1.5-7B-Chat.log 2>&1 &
